...
public class TestElGamal {
    ...
    private static void bcElGamal() {
        try {
            ...
            out.println("public key is : " + EncryptUtil.toHexString(elGamalPublicKey.getEncoded()));
            out.println("private key is : " + EncryptUtil.toHexString(elGamalPrivateKey.getEncoded()));
            ...
            out.println("私钥加密，公钥解密 -- 加密 : " + EncryptUtil.toHexString(result));
