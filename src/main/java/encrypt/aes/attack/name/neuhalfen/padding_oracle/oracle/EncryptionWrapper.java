package encrypt.aes.attack.name.neuhalfen.padding_oracle.oracle;

import encrypt.EncryptUtil;
import encrypt.aes.attack.name.neuhalfen.padding_oracle.CipherText;
...
//    public static final String HMAC_ALGORITHM = "HmacSHA1";
    ...
    public String toString() {
        ...
        return  String.format("{ algorithm:'%s', format:'%s', encoded:'%s' }", secretKey.getAlgorithm(), secretKey.getFormat(), EncryptUtil.toHexString(secretKey.getEncoded()) );
    }
}
